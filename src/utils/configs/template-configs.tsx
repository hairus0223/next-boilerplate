 ...
 * as these are stored in the cookie (cookie has the highest priority over the TemplateConfig):
 * 1. mode
 * 2. skin
 * 3. semiDark
 * 4. layout
...
const TemplateConfig: Config = {
  ...
  toastPosition: 'right' // 'top-right', 'top-center', 'top-left', 'bottom-right', 'bottom-center', 'bottom-left'
}
