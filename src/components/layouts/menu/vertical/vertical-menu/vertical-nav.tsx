...
import StyledBackdrop from '@/utils/@core/layouts/styles/styled-backdrop'
import { defaultBreakpoints, verticalNavToggleDuration } from '@/utils/configs/template-configs'
...
import StyledVerticalNav from '../styles/styled-vertical-nav'
import StyledVerticalNavBgColorContainer from '../styles/styled-vertical-nav-bg-color-container'
import StyledVerticalNavContainer from '../styles/styled-vertical-nav-container'
import styles from '../styles/vertical-nav-bg-image.module.css'
